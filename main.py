    ...
    for c in reversed(cnts):
        ...
        if area > min_area:
            ...
            for column in range(columns):
                ...
                new_image.crop(box).save('cuts/a.png')
                ...
                epic = Image.fromarray(np.asarray(epic))
                epic.save(
                    'epics/{}_{}_{}.png'.format(page_no, image_number, column))
                ...
                print('Done', (image_number, column))
                texts.append((page_no, image_number, column, text))
